...
public class JavaFxViewUtils {
    ...
    public static Scene getJFXDecoratorScene(JFXDecorator decorator) {
        ...
        stylesheets.addAll(
                JavaFxViewUtils.class.getResource("/css/jfoenix-fonts.css").toExternalForm(),
                JavaFxViewUtils.class.getResource("/css/jfoenix-design.css").toExternalForm(),
                JavaFxViewUtils.class.getResource("/css/jfoenix-main.css").toExternalForm());
        return scene;
    }
    ...
    public static Stage getNewStage(String title, String iconUrl, Parent root) {
        ...
        Scene scene = JavaFxViewUtils.getJFXDecoratorScene(newStage, title, iconUrl, root);
